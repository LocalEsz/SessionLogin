package github.quantizr.autogg.login.gui;
...
public class TokenManager extends GuiScreen {
	...
	public void initGui() {
		...
		newButton = new GuiButton(0, this.width / 2 - 100, guiTop + 160, "Login");
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		name.drawString(fontRendererObj, "Name", name.xPosition, name.yPosition - fontRendererObj.FONT_HEIGHT - 1,
				16777215);
		uuid.drawString(fontRendererObj, "UUID", uuid.xPosition, uuid.yPosition - fontRendererObj.FONT_HEIGHT - 1,
				16777215);
		token.drawString(fontRendererObj, "Session ID", token.xPosition, token.yPosition - fontRendererObj.FONT_HEIGHT - 1,
				16777215);
	}
